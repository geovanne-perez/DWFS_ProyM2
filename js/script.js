...
class Encuesta {
    ...
    IniciarEncuesta() {
        ...
        alert("Gracias por contestar la encuesta, presione enter para ver su score (Ver en consola) :");
    }
...
function obtenerUltimosCuestionario()
{
    ...
    alert("Por favor visualice los resultados de la búsqueda en la consola.");
}
